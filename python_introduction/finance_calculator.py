monthly_income = float(input("Enter your monthly income: ")) #prompt the user for monthly income
monthly_expenses = float(input("Enter your total monthly expenses: ")) #prompt the user for monthly expenses
